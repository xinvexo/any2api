...
any2api is a personal, self-hosted AI API aggregation proxy. One process combines standard OpenAI, Codex, Claude, Grok, and Kimi API keys, plus OAuth accounts for supported providers, behind OpenAI Responses, OpenAI Chat Completions, OpenAI Images, and Anthropic Messages endpoints.
