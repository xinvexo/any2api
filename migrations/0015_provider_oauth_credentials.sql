...
CREATE TABLE provider_credentials_v2 (
    ...
    secret_schema_version INTEGER NOT NULL CHECK (
        (credential_kind = 'api_key' AND secret_schema_version = 1)
        OR (credential_kind = 'oauth2' AND secret_schema_version = 1)
    ),
...
CREATE TABLE provider_credential_models_v2 (
    credential_id TEXT NOT NULL
        REFERENCES provider_credentials_v2(id) ON DELETE CASCADE,
...
INSERT INTO provider_credential_models_v2 (credential_id, upstream_model, created_at)
...
CREATE TABLE request_logs_v2 (
    ...
    credential_id TEXT
        REFERENCES provider_credentials_v2(id) ON DELETE SET NULL,
...
CREATE TABLE request_attempts_v2 (
    request_id TEXT NOT NULL
        REFERENCES request_logs_v2(request_id) ON DELETE CASCADE,
...
ALTER TABLE provider_credential_models_v2 RENAME TO provider_credential_models;
