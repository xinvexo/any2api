...
- Refresh keeps the account's stored `Global | Profile(id)` selection, strict SSRF policy, per-account singleflight gate, token-version CAS and serialized SQLite/reconcile/snapshot publication.
