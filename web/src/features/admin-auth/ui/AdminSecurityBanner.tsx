...
export function AdminSecurityBanner() {
  ...
  return (
    <div className="border-b border-warning/35 bg-warning/10 px-4 py-3 text-warning sm:px-7" role="status">
      <div className="mx-auto flex max-w-[1500px] items-start gap-3 text-sm leading-5">
